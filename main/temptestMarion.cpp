...
void lancerMoteurs()
{
    ...
    wb.velocityControl.setSetpoints(300, 0);  // (vitesse linéaire, vitesse angulaire)
}

void tournerMoteurs()
{
    printf("around the world\n");
    wb.velocityControl.setSetpoints(0, 200); 
}

void arreterMoteurs()
{
    printf("Arrêt des 2 moteurs\n");
    wb.velocityControl.setSetpoints(0, 0);  // pour arrêter moteurs
}
...
void initServomoteur()//https://components.espressif.com/components/espressif/servo/versions/0.1.0/readme
{
    //faire dans le terminal : idf.py add-dependency "espressif/servo^0.1.0"
        ...
        .channels = {
            .servo_pin = {
                PIN_Servo1, //AJOUTER le 2e servo
            },
            .ch = {
                LEDC_CHANNEL_0,
            },
